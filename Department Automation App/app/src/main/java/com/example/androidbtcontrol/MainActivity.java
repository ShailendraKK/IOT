...
//    TextView textInfo, textStatus, textByteCnt;
    ...
    EditText inputField;
    Button btnledon,btnledoff,btnvoice;
    TextView status;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  inputField = (EditText)findViewById(R.id.input);
        ...
        btnledon=(Button)findViewById(R.id.ledon);
        btnledoff=(Button)findViewById(R.id.ledoff);
        ...
        btnvoice=(Button)findViewById(R.id.speech);
